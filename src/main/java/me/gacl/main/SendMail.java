...
public class SendMail {
    ...
    */ 
    public static MimeMessage createSimpleMail(Session session)
        ...
        //邮件的文本内容
        message.setContent("h！", "text/html;charset=UTF-8");
        //返回创建好的邮件对象
        return message;
    }
     ...
     */ 
     public static MimeMessage createImageMail(Session session) throws Exception {
         ...
         text.setContent("这是一封邮件正文带图片<img src='cid:hello.jpg'>的邮件", "text/html;charset=UTF-8");
         // 准备图片数据
         MimeBodyPart image = new MimeBodyPart();
        // SendMail.class.getResource("hello.png").toURI().getPath();
        String filePath  = ClassLoader.getSystemResource("image\\hello.png").toURI().getPath();
        // System.out.println("start+++++++++++++++"+filePath+"+++++++++++++++++++++++++++++++++++");
         DataHandler dh = new DataHandler(new FileDataSource(filePath));
         image.setDataHandler(dh);
         image.setContentID("D:\\mailResource\\hello.jpg");
         // 描述数据关系
         ...
         message.writeTo(new FileOutputStream("D:\\mailResource\\mailResource.eml"));
         //返回创建好的邮件
         return message;
     }
      ...
      */ 
      public static MimeMessage createAttachMail(Session session) throws Exception{
          ...
          DataHandler dh = new DataHandler(new FileDataSource("D:\\mailResource\\hello.jpg"));
